...
def predict(tr_label, tr_sample, c, g, test_label, test_sample, del_model=1, model_name=None):
    ...
    else:  model_file = "/Users/joey/Documents/stockcal/fmodel/%s.model"%tr_file
...
def main():
    ...
    fd = open("/Users/joey/Documents/stockcal/fscore/%s.fscore"%train_file, 'w')
    for t in f_tuples:
        fd.write("%d: \t%.6f\n"%t)
    fd.close()
...
#   print(est_acc.index(max(est_acc)))
    ...
    if test_pathfile != "":
        ...
        ### predict
        pred_y = predict(train_label, train_sel_samp, c, g, test_label, test_sel_samp, 0, "/Users/joey/Documents/stockcal/fmodel/%s.model"%train_sel_name)
        ...
        out_name = "/Users/joey/Documents/stockcal/fpred/%s.%d.pred"%(test_file,fnum)
        fd = open(out_name, 'w')
...
initlog("/Users/joey/Documents/stockcal/fselect/%s.select"%train_file)
writelog("start: %s\n\n"%datetime.now())
main()
